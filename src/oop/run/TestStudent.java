...
public class TestStudent {
    public static void main(String[] args) {
        ...
        Student st = new Student(123,"asd",77,'j');
        //st는 래퍼런스 변수 : 객체의 주소저장용 변수
        ...
        //래퍼런스변수 = new 생성자();
        //클래스가 생성자를 가지고 있지 않을 때만 컴파일시 기본생성자가 자동 코드로 추가됨
        ...
        //4. this가 받은 주소 위치의 필드들에 초기값 기록함
        //5. 할당된 객체의 주소를 레퍼런스변수에 기록함
        System.out.println("st가 가진 주소 : "+st);
